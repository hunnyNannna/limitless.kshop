    ...
    <div class="wrapper"><br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <h2>All Girl Group Album List</h2>
                        ...
                        <div class="panel panel-success panel-size-custom">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM product WHERE category='Girlgroup Album' limit 0,3";
                                ...
                                <center>
                                        <div id="myDIV">
                                            <button class="btn active" onclick="location.href='prod_girl1.php'">1</button>
                                            <button class="btn" onclick="location.href='prod_girl2.php'">2</button> 
                                        </div> 
                                </center>  
