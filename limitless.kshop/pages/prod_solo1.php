                        ...
                        <div class="panel panel-success panel-size-custom">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM product WHERE category='Solo Album' limit 0,3";
                                ...
                                <center>
                                        <div id="myDIV">
                                            <button class="btn active" onclick="location.href='prod_solo1.php'">1</button> 
                                            <button class="btn" onclick="location.href='prod_solo2.php'">2</button> 
                                        </div> 
                                </center>    
                            </div>
                        </div> 
