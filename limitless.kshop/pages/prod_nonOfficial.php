    ...
    <div class="wrapper"><br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                        <h2>All Non-Official Merchandise List</h2>
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php
                                        ...
                                        $action = isset($_GET['action']) ? $_GET['action'] : "";
                                            ...
                                            $query = "SELECT * FROM product WHERE category='Non-Official' limit 0,3";
                                    ...
                                    <div id="myDIV">
                                        <button class="btn active" onclick="location.href='prod_nonOfficial.php'">1</button> 
                                    </div> 
