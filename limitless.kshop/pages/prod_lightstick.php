                        ...
                        <div class="panel panel-success panel-size-custom">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM product WHERE category='Lightstick' limit 0,10";
                                ...
                                <center>
                                        <div id="myDIV">
                                            <button class="btn active" onclick="location.href='prod_lightstick.php'">1</button>
                                        </div> 
                                </center>    
                            </div>
                        </div> 
