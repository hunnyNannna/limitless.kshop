...
<?php
    ...
    {   
        $id = mysqli_real_escape_string($dbconn, $_POST['admin_id']);
        ...
        if(empty($fname) || empty($email) || empty($uname) || empty($pword)) {    
            ...
            //updating the table
            $query = "UPDATE admin SET profile_pic='$pic',fullname='$fname',email='$email',username='$uname',password='$pword' WHERE admin_id=$id";
            $result = mysqli_query($dbconn,$query);
            
            if($result){
                //redirecting to the display page. In our case, it is index.php
                echo "<script>alert('Account has successfully updated.'); window.location.href='admin_panel1.php'</script>";
            }
        }
    }
?>
...
<?php
    //getting id from url
    $id=isset($_GET['admin_id']) ? $_GET['admin_id'] : die('ERROR: Record ID not found.');
    //selecting data associated with this particular id
    $result = mysqli_query($dbconn, "SELECT * FROM admin WHERE admin_id=$id");
                                    ...
                                    <div class="panel-body">
                                        <form action="admin_account_update.php" method="post">
                                            <div class="form group">
                                                <input type="hidden" class="form-control" id="admin_id" name="admin_id" value=<?php echo $_GET['admin_id'];?>>
                                                <label for="profile_pic">Profile Picture:</label>
                                                <input type="file" class="form-control" id="profile_pic" name="profile_pic" value="<?php echo $pic;?>">
