                        ...
                        <div class="panel panel-success panel-size-custom">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM product WHERE category='Boygroup Album' limit 6,3";
                                ...
                                <center>
                                        <div id="myDIV">
                                            <button class="btn" onclick="location.href='prod_boy1.php'">1</button> 
                                            <button class="btn" onclick="location.href='prod_boy2.php'">2</button> 
                                            <button class="btn active" onclick="location.href='prod_boy3.php'">3</button>
