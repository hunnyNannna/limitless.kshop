                                ...
                                <form method="post" action="user_payment.php">
                                    ...
                                    <table class="table table-condensed table-bordered">
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b><?php echo $row2['prod_name'];?></b><br><br><?php echo $row2['prod_desc']; ?></td>
                                                    ...
                                                    <td>     
                                                        <a href="user_edit_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-warning btn-round" type="button">update</button></a>
                                                        <a href="user_delete_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-danger btn-round" onclick="return confirm('Are you sure you want to delete?')" type="button">remove</button></a>
                                                    </td>
                                    ...
                                    ?>
                                            ...
                                            <script type="text/javascript">
                                                alert("Shopping cart empty! Add product.");
                                    ...
                                    ?>
                                            ...
                                            <br>
                                            <button  type="submit" id="" onclick="return confirm('Are you sure you want to checkout?')" name="submit" class="btn btn-main btn-round pull-right" data-toggle="modal" data-target="#myModal">
                                            <i class="now-ui-icons shopping_bag-16"></i> &nbsp Check Out</button> 
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="btn btn-main btn-round dropdown-toggle" size="1" name="city">
                                                            <option value="">Select city</option>
                                                            <option value="Perlis City">Perlis</option>
                                                            <option value="Kedah City">Kedah</option>
                                                            <option value="Pulau Pinang City">Pulau Pinang</option>
                                                            <option value="Perak City">Perak</option>
                                                            <option value="Selangor City">Selangor</option>
                                                            <option value="Kuala Lumpur City">Kuala Lumpur</option>
                                                            <option value="Negeri Sembilan City">Negeri Sembilan</option>
                                                            <option value="Melaka City">Melaka</option>
                                                            <option value="Johor City">Johor</option>
                                                            <option value="Kelantan City">Kelantan</option>
                                                            <option value="Terengganu City">Terengganu</option>
                                                            <option value="Pahang City">Pahang</option>
                                                            <option value="Sabah City">Sabah</option>
                                                            <option value="Sarawak City">Sarawak</option>
                                                        </select>  
                                                        ...
                                                        <input type="radio" name="paymethod" value="Online Banking"> Online Banking <br>
                                                        <input type="radio" name="paymethod" value="Shopee Pay"> Shopee Pay <br>
                                                        <input type="radio" name="paymethod" value="TnG E-Wallet"> TnG E-Wallet
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a><button name="order" class="btn btn-success btn-round"><i class="now-ui-icons shopping_delivery-fast"></i>  Place Order</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
