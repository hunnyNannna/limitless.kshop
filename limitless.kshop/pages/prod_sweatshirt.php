                                ...
                                <div class="panel-body">
                                    ...
                                    <?php
                                        ...
                                        $action = isset($_GET['action']) ? $_GET['action'] : "";
                                            ...
                                            $query = "SELECT * FROM product WHERE category='Sweatshirt' limit 0,5";
                                    ...
                                    <div id="myDIV">
                                        <button class="btn active" onclick="location.href='prod_sweatshirt'">1</button> 
                                    </div> 
