                        ...
                        <div class="panel panel-success panel-size-custom">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM product WHERE category='Girlgroup Album' limit 6,3";
                                ...
                                <center>
                                        <div id="myDIV">
                                            <button class="btn" onclick="location.href='prod_girl1.php'">1</button>
                                            <button class="btn active" onclick="location.href='prod_girl2.php'">2</button> 
                                        </div> 
                                </center>  
