...
<body class="index-page sidebar-collapse w3-content" style="max-width:1200px">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets/img/logo.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="user_search_index.php">
        ...
        <div class="w3-large w3-text-grey" style="font-weight:bold;">
            <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn" style="text-decoration:none;">Non-Official Merch <i class="fa fa-caret-down"></i></a>
                <div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
                    <a href="prod_nonOfficial.php" class="w3-bar-item w3-button" style="text-decoration:none;">Keychain</a> 
                    <a href="prod_nonOfficial.php" class="w3-bar-item w3-button" style="text-decoration:none;">Photocard Binder</a>
                    <a href="prod_nonOfficial.php" class="w3-bar-item w3-button" style="text-decoration:none;">Unofficial Photocard</a>
                </div>
            <a href="prod_lightstick.php" class="w3-bar-item w3-button" style="text-decoration:none;">Lightstick</a>
            <a onclick="myAccFunc1()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn1" style="text-decoration:none;">Albums <i class="fa fa-caret-down"></i></a>
                <div id="demoAcc1" class="w3-bar-block w3-hide w3-padding-large w3-medium">
                    <a href="prod_solo1.php" class="w3-bar-item w3-button" style="text-decoration:none;">Solo</a> 
                    <a href="prod_boy1.php" class="w3-bar-item w3-button" style="text-decoration:none;">Boy Group</a>
                    <a href="prod_girl1.php" class="w3-bar-item w3-button" style="text-decoration:none;">Girl Group</a>
                </div>
            <a href="prod_sweatshirt.php" class="w3-bar-item w3-button" style="text-decoration:none;">Sweatshirts</a>
            <a href="prod_cap.php" class="w3-bar-item w3-button" style="text-decoration:none;">Cap</a>
            <a href="prod_plushie.php" class="w3-bar-item w3-button" style="text-decoration:none;">Plushie</a>
            <a href="prod_seasongreeting.php" class="w3-bar-item w3-button" style="text-decoration:none;">Season Greetings</a><br><br>
        </div>
    </nav>
    ...
    <section>
        <div class="products" id="gallery" style="margin-right:50px;">
            ...
            <div class="w3-container ">
                <h2 class="section-text-header">Get our products</h2>
            </div>
