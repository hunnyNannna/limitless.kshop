                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections"> 
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM product ORDER BY prod_name ASC limit 0,5";
                                ...
                                <center>
                                    <div id="myDIV">
                                        <button class="btnpage active" onclick="location.href='admin_panel1.php'">1</button>
                                        ...
                                        <button class="btnpage" onclick="location.href='admin_panel4.php'">4</button> 
