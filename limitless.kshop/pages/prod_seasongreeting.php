    ...
    <div class="wrapper"><br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <h2>All Season Greeting List</h2>
                        ...
                        <div class="panel panel-success panel-size-custom">
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM product WHERE category='Season Greeting' limit 0,5";
                                ...
                                <center>
                                        <div id="myDIV">
                                            <button class="btn active" onclick="location.href='prod_seasongreeting.php'">1</button> 
                                        </div> 
                                </center>    
                            </div>
                        </div> 
